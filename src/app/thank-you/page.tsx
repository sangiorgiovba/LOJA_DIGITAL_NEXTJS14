          ...
          <div className='lg:col-start-2'>
            ...
            {order._isPaid ? (
              <p className='mt-2 text-base text-muted-foreground'>
               Seu pedido foi processado e seus produtos estão disponíveis para download abaixo.
                nos enviamos seu recibo e detalhes do pedido para {' '}
                {typeof order.user !== 'string' ? (
              ...
              <p className='mt-2 text-base text-muted-foreground'>
               Agradecemos seu pedido | processando-o no momento.
                Então aguarde e nos  enviará a confirmação em breve!
              </p>
            )}
